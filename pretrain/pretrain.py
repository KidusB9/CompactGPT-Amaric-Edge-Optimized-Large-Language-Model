...
from Kidus.trainer import Trainer
from Kidus import Kidus, Tokenizer
import utils
...
class PreTrainer(Trainer):
    def __init__(self, model_size:str, learning_rate: float, min_lr: float, batch_size: int, corpus_path: str, checkpoint_dir: str, tokenizer_path: str,
        ...
        if load:
            ...
            self.model: nn.Module = Kidus.from_name(model_size, pretrain=self.pretrain).to(torch.device("cuda"))
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Pretrain Kidus LLM Model ')
